...
def download_rpf_encoder(filename: str, local_dir: str) -> str:
    """Download a pretrained RPF encoder checkpoint from Hugging Face.

    Args:
        filename: Name of the encoder checkpoint file.
...
def download_tora_checkpoint(filename: str, local_dir: str) -> str:
    """Download a TORA model checkpoint from Hugging Face.
    ...
    Returns:
        Local path to the downloaded checkpoint.
    """
    raise NotImplementedError("TORA checkpoint hosting not yet configured.")
